...
const greeting = {
  ...
  subTitle: emoji(
    "A Data Scientist with 3 years of experience in work and Projects. I excel in  data analytics, data visualization, machine learning, natural language processing (NLP), predictive modeling, and data mining. With expertise in programming, problem-solving, and research."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1HUkYTMuta3mC4DDKdACHxdXZI48qKkMj/view?usp=sharing&usp=embed_facebook",
};
...
const achievementSection = {
  ...
  achivementsCards: [
...

    {
      ...
      footerLink: [
        {
          name: "ML by Standford University",
          url: "https://www.coursera.org/account/accomplishments/verify/YLMZHP6X7J4S?utm_campaign=sharing_cta&utm_content=cert_image&utm_medium=certificate&utm_product=course&utm_source=link",
        },
        {
          name: "IBM certification",
          url: "https://www.coursera.org/account/accomplishments/verify/BTFJQ6YJ3QE5?utm_source=link&utm_medium=certificate&utm_content=cert_image&utm_campaign=pdf_header_button&utm_product=course",
        },
      ],
    },
  ],
...
const blogSection = {
  ...
  blogs: [
    ...
    },
    {
      ...
      description:
        "Basic Intoduciton and code and paper reiview to Transformer",
    },
  ],
};
  ...
  talks: [
    {
      ...
      event_url:
        "https://www.instagram.com/p/CSjYCi-IVVd/?igshid=MzRlODBiNWFlZA%3D%3D",
    },
    {
